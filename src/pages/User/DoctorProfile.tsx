            ...
            <div className="flex flex-col md:flex-row justify-between items-start mb-5">
              ...
              <div className="flex items-center gap-3 mt-6 md:mt-0 mx-auto md:mx-0 bg-gray-50/80  border border-gray-100  px-5 py-3 rounded-2xl">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs font-bold text-gray-500 ">10 تقييم</p>
                </div>
              </div>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start w-1/2">
              <Button icon={<BiSolidCalendarCheck />}>
                {t("book_an_appointment")}
              </Button>
              <Button icon={<CiPhone />} variant="outline">
                {" "}
                {t("call_the_clinic")}
              </Button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-1">
              <div className="bg-white  p-6 rounded-2xl border border-gray-100  shadow-sm h-full">
                ...
                <h4 className="font-bold text-gray-800 ">عنوان العيادة</h4>
                <p className="text-gray-500  text-sm mb-6 leading-relaxed pt-3">
                  العنوان غير متوفر حالياً
                </p>
